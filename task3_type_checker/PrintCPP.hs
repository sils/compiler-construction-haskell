...
instance Print Exp where
  prt i e = case e of
   ...
   EGtEq exp0 exp -> prPrec i 9 (concatD [prt 9 exp0 , doc (showString ">=") , prt 10 exp])
   ...
   ETyped exp type' -> prPrec i 15 (concatD [doc (showString "(") , prt 0 exp , doc (showString ":") , prt 0 type' , doc (showString ")")])
